...
account-view-recently-closed-tabs = Onlangs gesloten tabbladen bekijken
account-tabs-closed-remotely =
    { $closedCount ->
        [one] { $closedCount } { -brand-short-name }-tabblad gesloten
       *[other] { $closedCount } { -brand-short-name }-tabbladen gesloten
    }
