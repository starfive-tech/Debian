...
crashed-header = Ææ. Því miður hrundi flipinn.
crashed-offer-help = Við getum hjálpað!
crashed-single-offer-help-message = Veldu { crashed-restore-tab-button } til að endurhlaða síðuna.
crashed-multiple-offer-help-message = Veldu { crashed-restore-tab-button } eða { crashed-restore-all-button } til að endurhlaða síðu/síðurnar.
