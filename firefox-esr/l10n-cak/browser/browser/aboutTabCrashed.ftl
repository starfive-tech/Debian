...
crashed-send-report-2 = Titaq jun rutzijol sachoj pa ruyonil richin yojtikïr yeqasöl taq k'ayewal achi'el re
crashed-comment =
    .placeholder = Cha'el taq rutzijol (ri taq rutzijol konojel winaqi' yetz'eton)
crashed-include-URL-2 = Titz'aqatisäx ri URLs taq ruxaq k'amaya'l akuchi' at k'o wi toq { -brand-short-name } xsach
...
crashed-auto-submit-checkbox-2 = Kek'ex taq ajowab'äl richin pa ruyonil kitaq kitzijol toq { -brand-short-name } nisach
