...
crashed-send-report-2 = გაგზავნეთ უეცარი გათიშვის ავტომატური მოხსენებები, რომ შევძლოთ მსგავსი ხარვეზების აღმოფხვრა.
crashed-comment =
    .placeholder = დამატებითი შენიშვნა (შენიშვნები, საჯაროდ გამოჩნდება)
crashed-include-URL-2 = მათ შორის საიტის ბმულები, რომლებზეც იმყოფებოდით, როცა { -brand-short-name } უეცრად გაითიშა
...
crashed-auto-submit-checkbox-2 = შეცვალეთ პარამეტრები, რომ ავტომატურად გაიგზავნოს მოხსენებები, როცა { -brand-short-name } უეცრად გაითიშება
