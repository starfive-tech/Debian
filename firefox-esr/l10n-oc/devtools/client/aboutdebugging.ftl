...
about-debugging-tmp-extension-terminate-bgscript-button = Tuar l’escript de rèireplan
...
about-debugging-extension-backgroundscript =
    .label = Escript de rèireplan

# Displayed for extension using a non-persistent background page (either an event page or
# background service worker) when the background script is currently running.
about-debugging-extension-backgroundscript-status-running = En execucion

# Displayed for extension using a non-persistent background page when is currently stopped.
about-debugging-extension-backgroundscript-status-stopped = Arrestat
