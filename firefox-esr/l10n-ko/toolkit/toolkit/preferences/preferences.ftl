...
primary-password-admin = 관리자는 사용자가 로그인과 비밀번호를 저장하기 위해 기본 비밀번호를 설정하도록 요구합니다.
primary-password-required-by-policy = 조직은 사용자가 로그인과 비밀번호를 저장하기 위해 기본 비밀번호를 설정하도록 요구합니다.
