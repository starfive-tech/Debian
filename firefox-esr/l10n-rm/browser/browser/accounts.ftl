...
account-view-recently-closed-tabs = Mussar ils tabs serrads dacurt
account-tabs-closed-remotely =
    { $closedCount ->
        [one] Serrà { $closedCount } tab da { -brand-short-name }
       *[other] Serrà { $closedCount } tabs da { -brand-short-name }
    }
