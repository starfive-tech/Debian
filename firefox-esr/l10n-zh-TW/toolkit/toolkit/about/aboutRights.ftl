...
rights-intro-point-1 = { -brand-short-name } 是依照 <a data-l10n-name="mozilla-public-license-link">Mozilla 公眾授權條款</a>中的條件所提供給您的。這表示您可以使用、複製，或散布 { -brand-short-name } 給其他人。歡迎您自行修改 { -brand-short-name } 的原始碼以滿足您的需求；Mozilla 公眾授權條款也同時賦予您散布修改版本的權利。
...
rights-intro-point-3 = { -brand-short-name } 當中的一些功能，像是程式錯誤回報員，將會讓您可以選擇是否要送出回饋給 { -vendor-short-name }。在送出回饋時，您必須授權 { -vendor-short-name } 使用您所送出的回饋內容以改善其產品、發布回饋內容於其網站，並散布這些使用者回饋。
