...
policy-CaptivePortal = ক্যাপটিভ পোর্টাল সমর্থন সক্রিয় বা অচল করুন।
...
policy-ExtensionUpdate = স্বয়ংক্রিয়ভাবে এক্সটেনশন হালনাগাদ সক্রিয় অথবা নিস্ক্রিয় করুন।
...
policy-LegacyProfiles = প্রতিটি ইনস্টলেশনের জন্য পৃথক প্রোফাইল প্রয়োগ করে বৈশিষ্ট্যটি নিস্ক্রিয় করুন
...
policy-Permissions2 = ক্যামেরা, মাইক্রোফোন, অবস্থান, বিজ্ঞপ্তি ও স্বতঃচালনার জন্য অনুমতিসমূহ নিয়ন্ত্রণ করুন।
