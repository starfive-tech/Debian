...
screenshots-connection-error-details = कृपया अपने इंटरनेट संपर्क की जाँच करें. यदि आप इंटरनेट से जुड़ने में सक्षम हैं, तो { -screenshots-brand-name } स्क्रीनशॉट सेवा के साथ एक अस्थायी समस्या हो सकती है.
screenshots-login-error-details = हम आपका शॉट सहेज नहीं सके क्योंकि { -screenshots-brand-name } स्क्रीनशॉट सेवा में कोई समस्या है. कृपया बाद में पुन: प्रयास करें.
