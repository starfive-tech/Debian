...
certificate-viewer-distribution-point = Ñemoasãiha
...
certificate-viewer-key-usages = Ojeporuvéva
certificate-viewer-extended-key-usages = Ojeporu hetavéva
...
certificate-viewer-critical-extension =
    .title = Ko jepysokue oñemongurusúma ivaikuaávaramo, he’iséva poruhára omboykeva’erã mboajepyre noikumbýiramo.
