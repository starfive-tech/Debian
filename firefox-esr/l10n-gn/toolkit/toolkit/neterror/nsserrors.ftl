...
psmerr-ssl2-disabled = Ndaikatúi eikekatu pe tenda oiporu rupi peteĩchagua itujáva ha nahekorosãiva SSL reheguáva.
...
ssl-error-unsupported-version = Ambue tendaguáva oiporuhína taperekoite rekorosãrã peteĩchagua noñemoneĩriva.
...
ssl-error-rx-unexpected-hello-request = SSL-pe og̃uahẽ ñe’ẽmondo ñomongetarã Hello Request eha’ãrõ’ỹva.
ssl-error-rx-unexpected-client-hello = SSL-pe og̃uahẽ ñe’ẽmondo ñomongetarã Client Hello eha’ãrõ’ỹva.
ssl-error-rx-unexpected-server-hello = SSL-pe og̃uahẽ ñe’ẽmondo ñomongetarã Server Hello eha’ãrõ’ỹva.
ssl-error-rx-unexpected-certificate = SSL-pe og̃uahẽ ñe’ẽmondo ñomongetarã Certificate eha’ãrõ’ỹva.
ssl-error-rx-unexpected-server-key-exch = SSL-pe og̃uahẽ ñe’ẽmondo ñomongetarã Server Key Exchange eha’ãrõ’ỹva.
ssl-error-rx-unexpected-cert-request = SSL-pe og̃uahẽ ñe’ẽmondo ñomongetarã Certificate Request eha’ãrõ’ỹva.
ssl-error-rx-unexpected-hello-done = SSL-pe og̃uahẽ ñe’ẽmondo ñomongetarã Server Hello Done eha’ãrõ’ỹva.
ssl-error-rx-unexpected-cert-verify = SSL-pe og̃uahẽ ñe’ẽmondo ñomongetarã Certificate Verify eha’ãrõ’ỹva.
ssl-error-rx-unexpected-client-key-exch = SSL-pe og̃uahẽ ñe’ẽmondo ñomongetarã Client Key Exchange eha’ãrõ’ỹva.
ssl-error-rx-unexpected-finished = SSL-pe og̃uahẽ ñe’ẽmondo ñomongetarã Finished eha’ãrõ’ỹva.
ssl-error-rx-unexpected-change-cipher = SSL-pe og̃uahẽ jehaipy Change Cipher Spec eha’ãrõ’ỹva.
ssl-error-rx-unexpected-alert = SSL-pe og̃uahẽ jehaipy Alert eha’ãrõ’ỹva.
ssl-error-rx-unexpected-handshake = SSL-pe og̃uahẽ jehaipy ñomongetarã eha’ãrõ’ỹva.
ssl-error-rx-unexpected-application-data = SSL-pe og̃uahẽ jehaipy Application Data eha’ãrõ’ỹva.
...
ssl-error-rx-unknown-alert = SSL-pe og̃uahẽ peteĩ jehaipy jesarekorãva pe jesarekorã moesakãha ojekuaa’ỹva ndive.
ssl-error-close-notify-alert = Pe ambue SSL jeikekatu apýra ombotýma ko jeikekatu.
ssl-error-handshake-unexpected-alert = Ambue SSL jeikekatu apýra noha’ãrõi jehaipy ñomongetarã og̃uahẽva chupe.
...
ssl-error-certificate-unknown-alert = Pe ambue SSL jeikekatu apýra oguereko apañuái ojekuaaporã’ỹva pe mboajepyréva og̃uahẽva chupe ndive.
...
ssl-error-pub-key-size-limit-exceeded = SSL mohendahavusu oñeha’ã oiporu ñemigua opavaveguáva óga pegua peteĩ tembiaporape’aty mbopapapypyre okayguápe g̃uarãva.
...
ssl-error-cert-kea-mismatch = Pe mboajepyréva ñeme’ẽmbyre ndaikatúi ojeporu pe algoritmo ñome’ẽ ñemigua poravopyréva ndive.
...
ssl-error-user-canceled-alert = Pe poruhára ambue jeike apyraguáva ojokóma ñomongetarãva.
...
ssl-error-rx-unexpected-new-session-ticket = Og̃uahẽ ndéve ñomongetarã ñe’ẽmondo Pyahu tíke rembiapo eha’ãrõ’ỹva.
...
ssl-error-rx-unexpected-uncompressed-record = SSL-pe og̃uahẽ jehaipy oñemomichĩpyre’ỹva nereha’ãrõiva.
...
ssl-error-rx-unexpected-cert-status = SSL-pe og̃uahẽ ñomongetarã ñe’ẽmondo Certificate Status nereha’ãrõiva.
ssl-error-unsupported-hash-algorithm = Algoritmo ñangarekoha TLS mombytaha’ỹre oiporúva heseguáva.
ssl-error-digest-failure = Tembiapoite heseguaitéva ndoikói.
ssl-error-incorrect-signature-algorithm = Algoritmo mboheraguapy oiko’ỹva oñemoha’eño peteĩ mba’eporu heraguapy mohendaha peguáva.
...
ssl-error-next-protocol-no-protocol = Pe mohendahavusu nomoneĩri mba’evéichagua taperekoite pe oiporúva omoherakuãháicha ALPN-pe.
ssl-error-inappropriate-fallback-alert = Pe mohendahavusu ombotove jepojopy oiporúva oguejypyréva peteĩchagua TLS itujavéva ome’ẽva mohendahavusúpe ykeko.
...
ssl-error-unsupported-signature-algorithm = Ñomongetaha oiporu ñembojopyru ipu’aka’ỹva teraguapygua ha algoritmo mba’eku’i.
...
sec-error-untrusted-issuer = Pe mboajepyréva me’ẽha ambue tendaguáva oñemongurusúma jerovia’ỹháramo poruhára rupi.
sec-error-untrusted-cert = Pe mboajepyréva me’ẽha ambue tendaguáva oñemongurusúma jerovia’ỹháramo poruhára rupi.
...
sec-error-cert-usages-invalid = Pe mboajepyréva jeporu rendag̃ua ndoikói.
...
sec-error-decryption-disallowed = Ndaikatúi oñembopapapy’o: oñembopapapy ojeporúvo peteĩ algoritmo ñemigua tuichakue oñemoneĩ’ỹva.
...
sec-error-cert-nickname-collision = Oĩmavoi peteĩ mboajepyréva pe téra’ãngaitépe.
sec-error-key-nickname-collision = Oĩmavoi peteĩ ñemigua hera’anga reheguaitéva.
...
sec-error-user-cancelled = Pe poruhára ojopýma Heja.
...
sec-error-inadequate-key-usage = Ñemigua jeporu mboajepyréva rehegua ndoikomo’ãi ko tembiapo reipotávape g̃uarã.
sec-error-inadequate-cert-type = Mboajepyréva noñemoneĩriva tembiporu’ípe g̃uarã.
sec-error-cert-addr-mismatch = Mboajepyréva kundaharape mboheraguapy rehegua ndojoguerahái kundaharape ndive ñe’ẽmondo moakãhápe.
...
sec-error-bad-nickname = Mboajepyréva rera’ãnga ojeporumahína.
...
sec-error-module-stuck = Pe ha’ãha PKCS #11 ndaikatúi oñemboguete ojeporu rupi gueteri.
...
sec-error-busy = NSS ndakatúi oñemboty. Oĩ gueteri mba’e ojeporuvahína.
sec-error-extra-input = Ñe’ẽmondo DER ndive papapypyréva oreko mba’ekuaarã ykegua ojeporu’ỹva.
...
sec-error-invalid-policy-mapping = Pe porureko rapete oguereko anypolicy
sec-error-policy-validation-failed = Mboajepyréva joajuha ndohupytýi ñemoañete porureko rehegua
...
sec-error-pkcs11-device-error = Peteĩ PKCS #11 ra’ãha ombojevyjey CKR_DEVICE_ERROR, he’ihápe oikoha peteĩ apañuái token térã slot ndive.
...
sec-error-bad-crl-dp-url = URL ndoikói térã noñemoneĩriva kyta réra CRL ñemoasãihápe.
sec-error-cert-signature-algorithm-disabled = Pe mboajepyréva oñemboheraguapy oiporúkuévo peteĩ algoritmo mboheraguapýva oñemongepyréva nahekorosãi rupi.
mozilla-pkix-error-key-pinning-failure = Mohendahavusu oiporu kutuha (HPKP), hákatu mba’evéichagua mboajepyre joajuha jeroviaháva ikatu ojejapo oñembojuehe hag̃ua pinset ndive. Kutuha añetéva ndaikatúi oñemyengovia.
mozilla-pkix-error-ca-cert-used-as-end-entity = Pe mohendahavusu oiporu mboajepyre jepysokue jejokopyréva ndive ome’ẽva chupe peteí mboajepyréva mburuvicháramo. Peteĩ mboajepyréva oñeme’ẽ porãvape g̃uarã, kóva ndaikatúi péicha oiko.
...
mozilla-pkix-error-v1-cert-used-as-ca = Ojeporu mboajepyre X.509 peteĩháva ndojeroviáiva omboaje hag̃ua mohendahavusu mboajepyréva. Mboajepyre X.509 peteĩháva ndoikovéima ha ndojeporuvéima va’erã emboheguapy hag̃ua ambuéva mboajepyre.
mozilla-pkix-error-not-yet-valid-certificate = Mohendahavusu ohechauka peteĩ mboajepyre oiko’ỹva gueteri.
mozilla-pkix-error-not-yet-valid-issuer-certificate = Peteĩ mboajepyre oiko’ỹva oiporu oguenohẽ hag̃ua mohendahavusu mboajepyréva.
