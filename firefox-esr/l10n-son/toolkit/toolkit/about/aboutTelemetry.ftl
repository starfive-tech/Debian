...
about-telemetry-archive-ping-header = Ɲooje
about-telemetry-page-title = Mooru-neešiyan bayhayey
about-telemetry-general-data-section = Yamma bayhayey
about-telemetry-environment-data-section = Windila bayhayey
about-telemetry-session-info-section = Dabariɲaa alhabar
...
about-telemetry-slow-sql-main = SQL ceeyayna hãayaney goy boŋ šilley ra
about-telemetry-slow-sql-other = SQL ceeyayna hãayaney faaba šilley ra
...
about-telemetry-error-fetching-symbols = Firka bangay jinay tammaasa zaayan waate. Guna wala war dobu Interneti ga nda ceeci taaga.
about-telemetry-time-stamp-header = waati tammaasa
about-telemetry-category-header = kuray margaw
about-telemetry-method-header = dabari
about-telemetry-object-header = jinay
about-telemetry-extra-header = tontoni
