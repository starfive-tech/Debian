...
default-browser-notification-message = <strong>Đặt { -brand-short-name } làm trình duyệt mặc định của bạn?</strong> Duyệt web nhanh chóng, an toàn và riêng tư bất cứ khi nào bạn sử dụng web.
