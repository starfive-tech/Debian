...
protections-panel-not-blocking-why-etp-on-tooltip-label =
    .label = Bloklasangiz, ayrim saytlaridagi elementlar ishlamasligi mumkin. Kuzatuvchilar ayrim tugma, shakl va login maydonchalarisiz sizni kuzata olmaydi.
protections-panel-not-blocking-why-etp-off-tooltip-label =
    .label = Bu saytdagi barcha kuzatuvchilar yuklandi, chunki siz himoyani oʻchirib qoʻygansiz.
