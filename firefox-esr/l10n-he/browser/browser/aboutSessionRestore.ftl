...
restore-page-error-title = אנו מצטערים, אך אירעה תקלה בעת שחזור הדפים שלך בחזרה.
restore-page-problem-desc = אירעה תקלה בעת שחזור ההפעלה הקודמת שלך. נא לבחור באפשרות שחזור ההפעלה כדי לנסות שוב.
