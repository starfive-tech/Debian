...
content-blocking-trackers-view-empty = No se n'ha detectat cap en aquest lloc
...
content-blocking-cookies-view-first-party-label = D'aquest lloc
...
tracking-protection-icon-disabled = S'ha DESACTIVAT la protecció contra el seguiment millorada en aquest lloc.
tracking-protection-icon-disabled-container =
    .aria-label = { tracking-protection-icon-disabled }
tracking-protection-icon-no-trackers-detected = No s'ha detectat cap element de seguiment conegut pel { -brand-short-name } en aquesta pàgina.
