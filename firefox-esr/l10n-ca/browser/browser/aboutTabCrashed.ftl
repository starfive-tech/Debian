...
crashed-send-report-2 = Envia un informe de fallada automàtic per ajudar a corregir errors com aquest
crashed-comment =
...
crashed-auto-submit-checkbox-2 = Actualitza les preferències per tal que s'enviïn informes automàticament en produir-se una fallada del { -brand-short-name }
