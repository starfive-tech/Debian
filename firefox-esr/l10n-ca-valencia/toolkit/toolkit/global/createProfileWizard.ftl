...
profile-creation-explanation-2 = Si esteu compartint esta còpia del { -brand-short-name } amb altres usuaris, podeu utilitzar els perfils per mantindre separada la informació de cadascun dels usuaris. Per fer-ho, cada usuari o usuària hauria de crear el seu propi perfil.

profile-creation-explanation-3 = Si sou l'única persona que utilitza esta còpia del { -brand-short-name } heu de tindre com a mínim un perfil. Si voleu, podeu crear diversos perfils per emmagatzemar-hi diferents preferències i paràmetres de configuració. Per exemple, potser vos agradaria tindre un perfil per a la faena i un altre per a ús personal.
