...
pdfjs-open-file-button =
    .title = Obri el fitxer
pdfjs-open-file-button-label = Obri
pdfjs-print-button =
    .title = Imprimeix
...
pdfjs-spread-none-button =
    .title = No agrupes les pàgines de dues en dues
...
pdfjs-printing-not-supported = Avís: la impressió no és plenament funcional en este navegador.
...
pdfjs-invalid-file-error = El fitxer PDF no és vàlid o està malmés.
...
pdfjs-password-label = Introduïu la contrasenya per obrir este fitxer PDF.
