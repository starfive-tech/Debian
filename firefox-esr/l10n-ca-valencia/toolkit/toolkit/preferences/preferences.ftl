...
pp-change2empty-in-fips-mode = Vos trobeu en mode FIPS. El FIPS requereix una contrasenya principal que no siga buida.
...
primary-password-admin = El vostre administrador sol·licita que definiu una contrasenya principal per guardar els inicis de sessió i les contrasenyes.
primary-password-description = Una contrasenya principal s'utilitza per protegir informació confidencial, com ara els inicis de sessió i les contrasenyes, en este dispositiu. Si creeu una contrasenya principal, se vos demanarà que la introduïu una vegada en cada sessió quan el { -brand-short-name } recuperi informació guardada protegida per contrasenya.
primary-password-warning = Assegureu-vos que recordeu la contrasenya principal que heu definit. Si l'oblideu, no podreu accedir a cap informació protegida en este dispositiu.
...
remove-primary-password-warning2 = Si elimineu la contrasenya principal, la vostra informació no estarà protegida en cas que l'ordinador es veja compromés.
