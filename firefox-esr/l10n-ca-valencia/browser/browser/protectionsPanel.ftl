...
protections-panel-not-blocking-why-etp-off-tooltip-label =
    .label = S'han carregat tots els elements de seguiment d'este lloc perquè les proteccions estan desactivades.

##

protections-panel-no-trackers-found = No s'ha detectat cap element de seguiment conegut pel { -brand-short-name } en esta pàgina.
