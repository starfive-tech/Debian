...
safeb-blocked-phishing-page-short-desc = Το { -brand-short-name } απέκλεισε αυτήν τη σελίδα, επειδή ενδέχεται να σας παραπλανήσει ώστε να κάνετε κάτι επικίνδυνο, όπως να εγκαταστήσετε λογισμικό ή να αποκαλύψετε προσωπικά δεδομένα, όπως κωδικούς πρόσβασης ή πιστωτικές κάρτες.
