...
whypaused-debugger-statement = Pausado en declaración del depurador
...
whypaused-event-breakpoint = Pausado en punto de quiebre del evento
...
whypaused-resume-limit = Pausado durante stepping
...
whypaused-breakpoint-condition-thrown = Error con punto de quiebre condicional
...
whypaused-promise-rejection = Pausado en rechazo de promesa

# The text that is displayed in a info block explaining how the debugger is
# currently paused at a watchpoint on an object property
whypaused-get-watchpoint = Pausado en el obtención de propiedad

# The text that is displayed in an info block explaining how the debugger is
# currently paused at a watchpoint on an object property
whypaused-set-watchpoint = Pausado en el obtención de propiedad
