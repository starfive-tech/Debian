...
third-party-button-to-unblock-module-disabled = Desbloquear este módulo (lista de bloqueo actualmente deshabilitada)
    .title = Actualmente marcado como bloqueado, aunque la lista de bloqueo está deshabilitada para esta ejecución de { -brand-short-name }. Haz clic para desbloquearlo.
    .aria-label = Actualmente marcado como bloqueado, aunque la lista de bloqueo está deshabilitada para esta ejecución de { -brand-short-name }. Haz clic para desbloquearlo.
