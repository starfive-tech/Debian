...
account-manage-devices = Pārvaldīt ierīces...
...
account-manage-devices-titlecase = Pārvaldīt ierīces…
...
account-connection-connected-with = Šis dators tagad ir savienots ar { $deviceName }.
