...
certificate-viewer-certificate-section-title = Seedamfaagu

## Error messages

certificate-viewer-error-message = Min korinooma yiytude kabaruuji seedamfaagu ngu, walla seedamfaagu ngu ko bonngu. Tiiɗno eto kadi.
certificate-viewer-error-title = Won caɗeele mbaɗi.

## Certificate information labels

certificate-viewer-email-address = Ñiiɓirde Iimeel
# Variables:
#   $firstCertName (String) - Common Name for the displayed certificate
certificate-viewer-tab-title = Seedamfaagu ngam { $firstCertName }
certificate-viewer-country = Leydi
certificate-viewer-dns-name = Innde DNS
certificate-viewer-ip-address = Ƴiiɓirde IP
certificate-viewer-other-name = Innde Woɗnde
