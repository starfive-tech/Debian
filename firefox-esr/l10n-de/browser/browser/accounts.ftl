...
account-view-recently-closed-tabs = Kürzlich geschlossene Tabs anzeigen
account-tabs-closed-remotely =
    { $closedCount ->
        [one] { $closedCount } { -brand-short-name }-Tab geschlossen
       *[other] { $closedCount } { -brand-short-name }-Tabs geschlossen
    }
