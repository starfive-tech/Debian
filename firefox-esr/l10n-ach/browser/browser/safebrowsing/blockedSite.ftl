...
safeb-blocked-phishing-page-title = Kakube me bwola tye anyim
safeb-blocked-malware-page-title = Limo kakube man romo balo kompiuta mamegi
safeb-blocked-unwanted-page-title = Kakube ma tye anyim ni twero bedo ki purugram maraco
safeb-blocked-harmful-page-title = Kakube ma tye anyim ni twero bedo ki purugram marac
safeb-blocked-phishing-page-short-desc = { -brand-short-name } ogengo potbuk man pien romo bwoli me timo gin mo ma rac calo keto purugram onyo nyuto ngec mamegi calo mung me donyo onyo kad me bank.
