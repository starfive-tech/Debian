...
account-reconnect = Ponovno povezivanje { $email }
account-verify = Potvrdi { $email }

## Displayed in the Send Tab/Page/Link to Device context menu when right clicking a tab, a page or a link.

account-send-to-all-devices-titlecase = Pošalji na sve uređaje
account-manage-devices-titlecase = Upravljaj uređajima…
...
account-single-tab-arriving-title = Kartica primljena
# Variables:
...
account-multiple-tabs-arriving-from-single-device =
    { $tabCount ->
        [one] { $tabCount } je kartica preuzeta s { $deviceName }
        [few] { $tabCount } su kartice preuzete s { $deviceName }
       *[other] { $tabCount } je kartica preuzeto s { $deviceName }
    }
...
account-multiple-tabs-arriving-from-unknown-device =
    { $tabCount ->
        [one] { $tabCount } kartica je pristigla
