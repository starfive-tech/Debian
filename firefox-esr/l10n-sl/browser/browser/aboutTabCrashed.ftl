...
crashed-send-report-2 = Pošljite avtomatizirano poročilo o sesutju, da lahko popravimo težave, kot je ta
crashed-comment =
    .placeholder = Neobvezni komentarji (vidni javnosti)
crashed-include-URL-2 = Vključite naslove strani, ki ste jih imeli odprte, ko se je { -brand-short-name } sesul
