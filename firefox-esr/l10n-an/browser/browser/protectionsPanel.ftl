...
protections-panel-not-blocking-why-etp-on-tooltip-label =
    .label = Blocar-los puede interferir con elementos en qualques puestos. Sin elementos de seguimiento, qualques botons, formularios y campos d'inicio de sesión podrían no funcionar.
protections-panel-not-blocking-why-etp-off-tooltip-label =
    .label = Totz los elementos de seguimiento en este puesto s'han cargau perque las proteccions son desactivadas.
